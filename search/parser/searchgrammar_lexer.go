...
func searchgrammarlexerLexerInit() {
	...
	staticData.serializedATN = []int32{
		...
		0, 13, 30, 1, 0, 0, 0, 15, 43, 1, 0, 0, 0, 17, 18, 5, 43, 0, 0, 18, 2,
		1, 0, 0, 0, 19, 20, 5, 45, 0, 0, 20, 4, 1, 0, 0, 0, 21, 22, 5, 42, 0, 0,
		22, 6, 1, 0, 0, 0, 23, 24, 5, 47, 0, 0, 24, 8, 1, 0, 0, 0, 25, 26, 5, 40,
...
const (
	...
	searchgrammarLexerT__5   = 6
	searchgrammarLexerNUMBER = 7
	searchgrammarLexerWS     = 8
)
